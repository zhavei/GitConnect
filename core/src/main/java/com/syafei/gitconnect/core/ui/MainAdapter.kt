package com.syafei.gitconnect.core.ui
...
import com.syafei.gitconnect.core.databinding.ListItemUserBinding
import com.syafei.gitconnect.core.domain.model.GitUser

class MainAdapter : ListAdapter<GitUser, MainAdapter.AdapterViewHolder>(DIFFUTILS) {
    ...
    override fun onBindViewHolder(holder: AdapterViewHolder, position: Int) {
        ...
        holder.binding.apply {
            ...
            Glide.with(holder.itemView.context)
                .load(positionItem.avatarUrl).circleCrop().apply(
    ...
    inner class AdapterViewHolder(var binding: ListItemUserBinding) :
